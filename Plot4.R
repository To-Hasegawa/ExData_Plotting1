...
#graph 3
with(data2, plot(data_time, Voltage, type="l", xlab="datetime", ylab="Voltage"))

#graph 4
with(data2, plot(data_time, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
